...
var TabPane = function (_a) {
    ...
    return (react_1.default.createElement(styles_1.default, __assign({ title: title, active: active, index: index, id: "tabpane-".concat(index), className: "tab__pane".concat(className ? " ".concat(className) : '').concat(active ? ' active' : ''), theme: theme }, rest), children));
};
