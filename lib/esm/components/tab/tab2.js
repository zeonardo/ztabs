...
var Tab2 = function (_a) {
    ...
    return panes.length ? (React.createElement(StyledTab, __assign({ className: "tab".concat(className ? ' ' + className : '') }, rest),
        React.createElement(TabList, { tabs: tabTitles, onClick: onActiveChange || onClick, active: activeIndex }),
        _renderedPanes.map(function (pane, index) { return cloneElement(pane, {
