...
var TabList = function (_a) {
    ...
    return (React.createElement(StyledTabList, { className: "tab__list".concat(className ? ' ' + className : ''), theme: theme }, tabs.map(function (tab, index) { return getItem(tab, index, className, active, onClick, theme); })));
};
